...
Om något gick fel med testerna ser det ut så här i din PR. Du får en kommentar om vad som gick fel samt din PR får labeln `Tests failed`. Eftersom du kör testerna när du taggar så bör detta inte inträffa.
