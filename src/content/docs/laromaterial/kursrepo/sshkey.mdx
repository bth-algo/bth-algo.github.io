---
title: "⚠️ SSH-nycklar för autentisering mot GitHub" 
...
:::note
På bilderna i denna artikel står det `webtec` som kursnamn. Ignorera det och låtsas som att det står `algo`, vilket det ska göra för er.
:::
